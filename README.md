...
1、The script Generate_T_Matrix.m constructs the transition  matrix T using an offline simulation model, with results stored in T_Matrix.mat.

2、The accuracy is validated in Test_T_Matrix.m by comparing Simulink simulation results with those derived from the transition  matrices.
